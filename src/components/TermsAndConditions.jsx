    ...
    <div className="min-h-screen pt-10 bg-[#050505] text-white font-sans relative overflow-hidden selection:bg-[#ff9f20] selection:text-white">
      ...
      <div className="container mx-auto px-6 py-24 relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div className="group bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.04] transition-all duration-300 hover:border-white/10">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              While we aim to keep the information accurate, we do not guarantee
              completeness, reliability, or suitability. Any action you take
              based on the information here is at your own risk. DSS Digital
              Success Solutions LLP will not be responsible for any loss or
          ...
          <div className="group bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.04] transition-all duration-300 hover:border-white/10">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your use of any information, products, or services displayed on
              this website is entirely your responsibility. It is your duty to
              ensure that any service or information meets your specific
              requirements.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:items-start">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed mb-4">
                  All materials on this website are owned by or licensed to{" "}
                  <span className="text-white">
                    DSS Digital Success Solutions LLP
                  </span>
                  . This includes the website design, layout, appearance,
          ...
          <div className="group bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.04] transition-all duration-300 hover:border-white/10">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              All trademarks shown on this website that are not owned or
              licensed to DSS Digital Success Solutions LLP are acknowledged.
              Unauthorized use of trademarks is prohibited.
            </p>
          </div>
          <div className="group bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.04] transition-all duration-300 hover:border-white/10">
            <div className="w-12 h-12 rounded-full bg-[#0078f0]/10 flex items-center justify-center mb-6 border border-[#0078f0]/20 group-hover:scale-110 transition-transform">
              <NextLink href="#" className="w-6 h-6 text-[#0078f0]">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              website or document without obtaining prior written consent from
              DSS Digital Success Solutions LLP.
            </p>
          </div>
          <div className="group bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.04] transition-all duration-300 hover:border-white/10">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              consequential damages arising from your use of this website. Use
          ...
          <div className="md:col-span-2 group bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.04] transition-all duration-300 hover:border-white/10">
            <div className="flex flex-col md:flex-row gap-6 md:items-center">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Any dispute arising from the use of this website shall be
                  governed by the laws of{" "}
                  <span className="text-white font-bold">India</span> and shall
                  fall under the jurisdiction of the appropriate authorities
                  located in India.
                </p>
              </div>
            </div>
        ...
        <div className="mt-20 pt-12 border-t border-white/10">
          <h2 className="text-xl font-bold   tracking-widest text-center mb-10 text-gray-500">
            Contact for Legal Queries
          </h2>
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <a
              href="mailto:info@digitalsuccesssolutions.in"
              className="flex items-center gap-4 p-6 bg-white/5 border border-white/5 rounded-xl hover:bg-[#0078f0] hover:border-[#0078f0] transition-all duration-300 group"
            >
              <Mail className="w-6 h-6 text-[#0078f0] group-hover:text-white transition-colors" />
              <div>
                <span className="block text-xs font-bold   tracking-widest text-gray-500 group-hover:text-white/80">
                  Email Us
                </span>
            ...
            <a
              ...
              className="flex items-center gap-4 p-6 bg-white/5 border border-white/5 rounded-xl hover:bg-[#ff9f20] hover:border-[#ff9f20] transition-all duration-300 group"
            >
