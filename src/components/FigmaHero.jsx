...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-30 min-h-screen bg-black overflow-hidden flex items-center">
      ...
      <div
        ref={orb1}
        className="absolute top-20 left-20 w-80 h-80 bg-[#0078f0] rounded-full blur-3xl opacity-30"
      />
      <div
        ref={orb2}
        className="absolute top-40 right-32 w-96 h-96 bg-purple-600 rounded-full blur-3xl opacity-20"
      />
      <div
        ref={orb3}
        className="absolute bottom-32 left-1/4 w-72 h-72 bg-cyan-500 rounded-full blur-3xl opacity-25"
      />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
          ...
          <div>
            <h1
              ref={titleRef}
              className="text-6xl lg:text-7xl   tracking-tight leading-none"
            >
            ...
            <p
              ref={subtitleRef}
              className="mt-8 text-xl md:text-2xl text-zinc-300 font-light leading-relaxed max-w-2xl"
            >
              We are the{" "}
              <span className="text-[#0078f0] font-bold">
                Best Digital Marketing Agency
              </span>{" "}
              in Indore. Our digital experts use the latest tools & technologies
