      ...
      <div className="container mx-auto px-6 py-24 relative z-10 max-w-5xl">
        <div className="text-center mb-20">
          ...
          <h1 className="text-5xl md:text-7xl   tracking-tighter leading-none mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0078f0] to-[#ff9f20]">
              POLICY
            </span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed font-light">
            ...
            <span className="text-white font-medium">
              DSS Digital Success Solutions LLP
            </span>{" "}
            collects, uses, protects, and manages information from users of
        ...
        <div className="space-y-12">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-3">
                  <span className="md:hidden text-[#0078f0]">01.</span>{" "}
                  Information We Collect
                </h2>
                <p className="text-gray-400 mb-6 leading-relaxed">
                  You can browse digitalsuccesssolutions.in without sharing
                  personal details. We collect personally identifiable
                  information only when you choose to provide it, such as:
                </p>
                <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-3 text-sm text-gray-300 bg-white/5 px-4 py-3 rounded-lg border border-white/5"
                    >
          ...
          <div className="group relative bg-white/[0.02] border border-white/5 rounded-2xl p-8 md:p-12 hover:bg-white/[0.04] transition-colors duration-500">
            <div className="flex items-start gap-6">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-3">
                  <span className="md:hidden text-[#ff9f20]">02.</span>{" "}
                  Non-Personal Info &amp; Cookies
                </h2>
                <p className="text-gray-400 mb-6 leading-relaxed">
                  We may collect non-personal information when users interact
                  with the website. This can include browser type, device
                  details, operating system, and similar technical data.
                </p>
                <div className="p-6 bg-black/40 rounded-xl border border-white/5">
                  <h3 className="text-sm font-bold   tracking-widest text-gray-500 mb-4">
                    Cookies Usage
                  </h3>
          ...
          <div className="group relative bg-white/[0.02] border border-white/5 rounded-2xl p-8 md:p-12 hover:bg-white/[0.04] transition-colors duration-500">
            <div className="flex items-start gap-6">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-3">
                  <span className="md:hidden text-[#0078f0]">03.</span> How We
                  Use Information
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="p-4 rounded-lg bg-white/5 border border-white/5">
                    ...
                    <p className="text-sm text-gray-400">
                      Responding to queries and fulfilling service requests.
                    </p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/5 border border-white/5">
                    <h4 className="font-bold text-white mb-1">Optimization</h4>
                    <p className="text-sm text-gray-400">
                      Improving website performance and customer service.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 flex items-center gap-3">
                  <span className="md:hidden text-[#ff9f20]">04.</span> Changes
                  to This Policy
                </h2>
                <p className="text-gray-400 leading-relaxed">
                  We may update this Privacy Policy at any time. We encourage
                  users to review this page regularly to stay informed of any
                  changes. Your ongoing use of the website confirms your
        ...
        <div className="mt-20 pt-12 border-t border-white/10">
          <h2 className="text-xl font-bold   tracking-widest text-center mb-10">
            Contact Us
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a
              href="mailto:info@digitalsuccesssolutions.in"
              className="group flex flex-col items-center p-8 bg-white/5 border border-white/5 rounded-2xl hover:bg-[#0078f0] hover:border-[#0078f0] transition-all duration-300"
            >
              <Mail className="w-8 h-8 text-[#0078f0] mb-4 group-hover:text-white transition-colors" />
              <span className="text-xs font-bold   tracking-widest text-gray-500 group-hover:text-white/80 mb-1">
                Email
              </span>
            ...
            <a
              href="tel:6264398990"
              className="group flex flex-col items-center p-8 bg-white/5 border border-white/5 rounded-2xl hover:bg-[#ff9f20] hover:border-[#ff9f20] transition-all duration-300"
            >
            ...
            <a
              ...
              className="group flex flex-col items-center p-8 bg-white/5 border border-white/5 rounded-2xl hover:bg-white hover:border-white hover:text-black transition-all duration-300"
            >
              <Globe className="w-8 h-8 text-white mb-4 group-hover:text-black transition-colors" />
              <span className="text-xs font-bold   tracking-widest text-gray-500 group-hover:text-black/60 mb-1">
                Website
              </span>
        ...
        <div className="mt-12 text-center text-xs text-gray-600 font-mono   tracking-widest">
