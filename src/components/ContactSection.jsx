  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-0 left-0 w-[50vw] h-[50vw] bg-[#ff9f20]/10 rounded-full blur-[150px] animate-pulse"
      ...
      <div className="container mx-auto relative z-10 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div ref={infoRef} className="flex flex-col justify-center">
            <div className="flex items-center gap-4 text-gray-500 text-xs font-mono   tracking-[0.3em] mb-8">
              <div className="w-12 h-[1px] bg-gray-700" />
              <span>Get In Touch</span>
            </div>

            <h2 className="text-5xl md:text-7xl   tracking-tighter leading-none mb-8">
              LET'S BUILD <br />
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md mb-12">
              Have a project in mind? We help brands scale through design,
              strategy, and technology. Let's start the conversation.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-6 group cursor-pointer">
                ...
                <div>
                  <h4 className="text-sm font-bold   tracking-widest text-white mb-1">
                    Call Us
                  </h4>
          ...
          <div
            ...
            className="bg-white/[0.02] backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-[2rem] relative overflow-hidden flex flex-col justify-center min-h-[500px]"
          >
            {/* Form Glow */}
            ...
            {status === "success" ? (
              ...
              <div className="relative z-10 flex flex-col items-center text-center animate-fade-in-up">
                ...
                <h3 className="text-3xl   tracking-tight text-white mb-4">
                  Message Sent!
                </h3>
                ...
                <button
                  ...
                  className="text-[#0078f0] font-bold text-sm   tracking-widest hover:text-white transition-colors"
                >
              ...
              <form
                ...
                className={`relative z-10 flex flex-col gap-8 transition-opacity duration-500 ${status === "submitting" ? "opacity-50 pointer-events-none" : "opacity-100"}`}
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="bg-transparent border-b border-white/20 py-4 text-white placeholder-gray-700 focus:outline-none focus:border-[#0078f0] transition-colors"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-xs font-bold   tracking-widest text-gray-500">
                    ...
                    <input
                      ...
                      className="bg-transparent border-b border-white/20 py-4 text-white placeholder-gray-700 focus:outline-none focus:border-[#ff9f20] transition-colors"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="bg-transparent border-b border-white/20 py-4 text-white focus:outline-none focus:border-[#0078f0] transition-colors appearance-none cursor-pointer"
                  >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="bg-transparent border-b border-white/20 py-4 text-white placeholder-gray-700 focus:outline-none focus:border-[#ff9f20] transition-colors resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  type="submit"
                  className="group relative w-full py-5 bg-white text-black font-bold   tracking-widest overflow-hidden rounded-lg mt-4 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-shadow disabled:cursor-not-allowed"
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-r from-[#0078f0] to-[#ff9f20] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left ${status === "submitting" ? "hidden" : "block"}`}
                  />
                </button>
              </form>
            )}
