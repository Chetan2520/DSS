  ...
  const testimonials = [
    {
      ...
      poster:
        "https://images.unsplash.com/photo-1556155092-490a1ba16284?auto=format&fit=crop&q=80&w=600&h=1066",
      name: "Rohan Sharma",
    ...
    },
    {
      ...
      video: "/videos/Video-793.mp4",
      poster:
        "https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=600&h=1066",
      name: "Vikram Singh",
      role: "CEO, MixNuts",
    },
    {
      ...
      video: "/videos/Video-793.mp4",
      poster:
        "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=600&h=1066",
      name: "Ankit Patel",
      role: "Realtor",
    },
    {
      ...
      video: "/videos/Video-793.mp4",
      poster:
        "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=600&h=1066",
      name: "Mayank Jain",
      role: "CTO, TechVision",
    },
    {
      ...
      video: "/videos/Video-793.mp4",
      poster:
        "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=600&h=1066",
      name: "Suresh Kumar",
      role: "Director, Luxe",
    },
  ];
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-20 will-change-transform">
          <div className="flex items-center justify-center gap-4 text-gray-500 text-xs font-mono   tracking-[0.2em] mb-6">
            <div className="w-12 h-[1px] bg-gray-700" />
            <span>Client Love</span>
            <div className="w-12 h-[1px] bg-gray-700" />
          </div>

          <h2 className="text-6xl md:text-7xl   tracking-tighter leading-none text-white mix-blend-exclusion">
            Real Stories. <br />
            ...
            >
              ...
              <div className="w-full h-full bg-[#111] rounded-[1.5rem] overflow-hidden border border-white/10 relative shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6">
                  ...
                  <p className="text-xs font-mono text-[#ff9f20] tracking-wider   opacity-80">
                    {t.role}
                  </p>
                </div>
              </div>
