          ...
          { val: 0 },
          {
            ...
            onUpdate: function () {
              ...
              target.innerText =
                current +
                (finalValue.includes("+") ? "+" : "") +
                (finalValue.includes("Years") ? " Years" : "");
            },
          },
        );
      });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          ...
          <div ref={textRef} className="space-y-8">
            ...
            <p className="text-xl text-zinc-300 leading-relaxed">
              We're a team of creators, thinkers, and digital craftsmen who
              believe that every brand deserves to stand out — not just exist.
            </p>

            <p className="text-lg text-zinc-400 leading-relaxed">
              From startups to industry leaders, we've helped{" "}
              <strong>500+ brands</strong> transform their online presence into
              powerful revenue-generating assets. No templates. No shortcuts.
              Just pure strategy, creativity, and results.
            </p>
            ...
            <div className="pt-8">
              <blockquote className="text-2xl md:text-3xl font-medium italic text-zinc-200 border-l-4 border-blue-500 pl-6">
                "Your success is our success. Every pixel, every line of code —
                it's all built to make you win."
              </blockquote>
            </div>
          </div>
        </div>
