      ...
      >
        ...
        <div className="hidden md:flex w-2/5 relative flex-col justify-between p-10 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-bold   tracking-wider text-white mb-6">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              Available Now
            </div>
            <h2 className="text-4xl   text-white leading-tight">
              Let's Build <br /> Something{" "}
              <span className="text-[#ff9f20]">Great.</span>
            </h2>
          </div>
        ...
        <div className="w-full md:w-3/5 bg-[#050505] p-6 md:p-10 relative overflow-y-auto max-h-[90vh] md:max-h-auto">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            {/* Services Tags */}
            <div className="pt-4">
              <p className="text-sm text-zinc-400 mb-3 block">
