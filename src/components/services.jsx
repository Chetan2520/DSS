  ...
  return (
    <section ref={containerRef} className="bg-[#050505] pb-24 relative">
      ...
      <div className="pt-24 pb-12 px-6 md:px-12 max-w-7xl mx-auto text-center">
        <span className="text-[#ff9f20] font-bold tracking-[0.2em]   text-sm">
          What We Do Best
        </span>
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          We offer a comprehensive suite of digital solutions designed to scale
          your business from <span className="text-white">Zero to Hero</span>.
        </p>
      </div>
            ...
            >
              <div className="grid md:grid-cols-2 min-h-[500px] md:h-[550px]">
                ...
                <div className="p-8 md:p-16 flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div
                    className={`absolute top-[-50%] left-[-50%] w-[100%] h-[100%] bg-gradient-to-br ${service.color} opacity-10 blur-[100px] rounded-full group-hover:opacity-20 transition-opacity duration-500`}
                  />

                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      <span
                        className={`text-6xl   text-transparent bg-clip-text bg-gradient-to-r ${service.color} opacity-40`}
                      >
                        {service.id}
                      </span>
                      <div
                        className={`h-[2px] w-20 bg-gradient-to-r ${service.color}`}
                      />
                    </div>
                  ...
                  <div className="relative z-10 mt-10">
                    <button className="group/btn flex items-center gap-2 text-white font-bold text-lg   tracking-wider transition-all">
                      Learn More
                      <span
                        className={`bg-gradient-to-r ${service.color} rounded-full p-2 group-hover/btn:translate-x-2 transition-transform`}
                      >
                        <svg
                ...
                <div className="relative h-[300px] md:h-full overflow-hidden">
                  <div
                    className={`absolute inset-0 bg-gradient-to-b from-transparent to-[#0a0f1d] z-10 opacity-50`}
                  />

                  {/* Gradient Overlay for Brand Color Tint */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-20 mix-blend-color z-10`}
                  />
      ...
      {/* space for last card visibility */}
