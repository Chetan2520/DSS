...
const NextGenAiHero = () => {
  ...
  const nextGenGradient =
    "radial-gradient(ellipse at 50% 10%, rgba(0, 191, 255, 0.25) 0%, transparent 80%)";
  const textureStyle = {
    ...
    >
      ...
      */}
      ...
      <div className="relative z-10 max-w-4xl text-center pt-20">
        ...
        {/* <div className="mb-6 inline-flex items-center justify-center rounded-full bg-blue-500/10 px-4 py-1 text-xs font-semibold   tracking-wider text-blue-400 border border-blue-500/30 backdrop-blur-sm">
          Welcome to DSS
        </div> */}
