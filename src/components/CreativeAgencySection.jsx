    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div ref={titleRef} className="text-center mb-20">
          <h2 className="text-7xl md:text-8xl   tracking-tighter leading-none">
            <span className="bg-gradient-to-r from-blue-400 to-blue-200 bg-clip-text text-transparent">
              We Craft
            </span>
          </h2>
          <h2 className="text-7xl md:text-8xl   tracking-tighter leading-none -mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
          {services.map((service, i) => (
            ...
            >
              {/* Card Glow */}
              {/* bg-gradient-to-br from-[#0078f0]/40 to-[#ff6b00]/40 */}{" "}
              {/* ye line ki classniche k div me lagani hai if glow cahiye */}
              ...
              <div className="relative bg-black/80 backdrop-blur-xl border border-zinc-800 rounded-3xl p-10 h-full transition-all duration-700 hover:border-[#0078f0]/60 hover:shadow-2xl hover:shadow-[#0078f0]/30">
                <div
                  className={`w-20 h-20 rounded-2xl mb-8 flex items-center justify-center text-white
                  ${
                    i % 2 === 0
                ...
                <p className="text-zinc-400 leading-relaxed">
                  ...
                  cutting-edge technology and creative vision.
                </p>
              </div>
            </div>
          ))}
