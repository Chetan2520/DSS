...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-40 min-h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      <div
        ref={glowRef}
        className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#0078f0] rounded-full blur-3xl opacity-40 -z-20"
      />

      {/* Grain Texture */}
      <div
        className="absolute inset-0 opacity-20 pointer-events-none mix-blend-soft-light -z-10"
        style={{
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <h1
            ref={titleRef}
            className="text-7xl md:text-8xl lg:text-9xl xl:text-[10rem]   tracking-tighter leading-none"
          >
          ...
          <p
            ref={subtitleRef}
            className="mt-10 text-2xl md:text-4xl font-light text-zinc-400 max-w-4xl mx-auto leading-relaxed"
          >
          ...
          <div className="mt-20 flex flex-wrap justify-center items-center gap-12 opacity-80">
            ...
            <div className="text-center">
              <p className="text-5xl   text-[#0078f0]">10+</p>
              <p className="text-zinc-500">Countries</p>
            </div>
            <div className="text-center">
              <p className="text-5xl   text-white">4.9</p>
