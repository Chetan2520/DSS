...
export default function AboutDigitalSuccess() {
        ...
        gsap.fromTo(
          ...
          { innerText: 0 },
          {
            ...
            onUpdate: function () {
              ...
              element.innerText =
                Math.ceil(this.targets()[0].innerText) + stat.suffix;
            },
          },
        );
      });
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-[#050505] py-24 px-6 md:px-12 overflow-hidden"
    >
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={textRef} className="space-y-8 relative z-10">
            <div>
              <span className="text-[#ff9f20] font-bold tracking-[0.2em] text-sm   flex items-center gap-3">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              <strong className="text-white">Digital Success Solutions</strong>{" "}
              is more than just an agency; we are growth partners for NGOs,
              startups, and ambitious brands. Based in the heart of{" "}
              <span className="text-[#0078f0]">Indore (M.P.)</span>, we blend
              creative storytelling with data-driven performance to turn
              businesses into brands.
            </p>

            <div className="border-l-4 border-[#ff9f20] pl-6 py-2 bg-white/[0.02] rounded-r-lg">
              <p className="text-gray-300 italic">
                "We don't just run ads; we engineer growth. From
                high-performance websites to ROI-driven campaigns, we build
                strong digital identities that last."
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              {[
                ...
                <span
                  key={i}
                  className="px-4 py-2 rounded-full border border-white/10 text-sm text-gray-300 bg-white/5 hover:border-[#0078f0] transition-colors cursor-default"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              {statsData.map((stat, i) => (
                <div
                  ...
                  `}
                >
                  <p className="text-sm font-medium text-gray-500   tracking-wider mb-2 group-hover:text-white transition-colors">
                    {stat.label}
                  </p>
                  <h3
