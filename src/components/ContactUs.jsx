      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-20 relative z-10">
        ...
        <div className="flex flex-col justify-start space-y-10">
          ...
          <div className="space-y-6">
            ...
            >
              Let us know your goals, challenges, and vision, and we'll craft
              tailored strategies to achieve success.
            </motion.p>
          </div>
        ...
        <div className="relative">
          <div className="bg-[#0b1224]/60 backdrop-blur-3xl rounded-4xl md:rounded-[50px] border border-white/5 p-6 md:p-14 shadow-2xl relative overflow-hidden">
            {/* Tab Switcher */}
            <div className="inline-flex p-1 bg-[#1a233a] border border-white/5 rounded-full mb-12">
              <button
                onClick={() => setTab("quote")}
                className={`px-5 md:px-10 py-3.5 rounded-full text-xs font-medium  tracking-wide transition-all duration-300 ${tab === "quote" ? "bg-white text-black shadow-xl" : "text-gray-400 hover:text-white"}`}
              >
                Request A Quote
              </button>
              <button
                onClick={() => setTab("call")}
                className={`px-5 md:px-10 py-3.5 rounded-full text-xs font-medium tracking-wide transition-all duration-300 ${tab === "call" ? "bg-white text-black shadow-xl" : "text-gray-400 hover:text-white"}`}
              >
                Book A Call
              </button>
            </div>
              ...
              {tab === "quote" ? (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <input
                        ...
                        className="bg-[#1a233a]/50 border border-white/10 rounded-full px-5 md:px-8 py-4 md:py-5 focus:border-blue-500/50 outline-none transition-all placeholder:text-gray-500 text-sm"
                        required
                      />
                      <input
                        name="email"
                      ...
                      <div className="flex items-center bg-[#1a233a]/50 border border-white/10 rounded-full px-5 md:px-8 py-4 md:py-5 focus-within:border-blue-500/50 transition-all group">
                        <span className="text-xs font-bold text-gray-400 border-r border-white/10 pr-4 mr-4">
                            +91
                        </span>
                        <input
                          name="phone"
                      ...
                      <div className="relative">
                        <select
                          name="budget"
                          className="w-full bg-[#1a233a]/50 border border-white/10 rounded-full px-5 md:px-8 py-4 md:py-5 outline-none text-white text-sm appearance-none cursor-pointer focus:border-blue-500 shadow-xl transition-all"
                        >
                          <option value="" className="bg-[#0b1224]">
                            Budget Range *
                          </option>
                          <option value="10k-25k" className="bg-[#0b1224]">
                            ₹10k - ₹25k
                          </option>
                          <option value="25k-50k" className="bg-[#0b1224]">
                            ₹25k - ₹50k
                          </option>
                          <option value="50k-1lakh" className="bg-[#0b1224]">
                            ₹50k - ₹1 Lakh
                          </option>
                          <option value="1lakh-3lakh" className="bg-[#0b1224]">
                            ₹1 Lakh - ₹3 Lakh
                          </option>
                          <option value="3lakh+" className="bg-[#0b1224]">
                            ₹3 Lakh+
                          </option>
                        </select>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full bg-[#1a233a]/50 border border-white/10 rounded-2xl md:rounded-[35px] px-8 py-6 focus:border-blue-500/50 outline-none transition-all placeholder:text-gray-500 text-sm resize-none"
                      required
                    />
                ...
                >
                  ...
                  <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white/5 rounded-full flex items-center justify-center animate-pulse border border-white/10 shadow-2xl">
                    <Phone
                      size={36}
                      className="text-white sm:w-[48px] sm:h-[48px]"
                    />
                  </div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <p className="text-gray-400 max-w-xs sm:max-w-sm mx-auto text-sm sm:text-base md:text-lg leading-relaxed">
                      Skip the forms and speak with our experts directly to
