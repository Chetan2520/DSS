    ...
    services: [
      {
        ...
        description: "Build fast, responsive, and SEO-friendly websites in India designed to attract customers and drive conversions.",
      ...
      },
      {
        ...
        path: "/ecommerce-development-company-in-indore", // Assuming app dev is linked or has a similar page
      ...
      },
      {
        ...
        path: "/website-development-company-in-india", // Fallback to webdev or similar
            ...
            <div className="inline-flex   border border-white/10 p-1.5 rounded-full backdrop-blur-sm relative">
              {servicesCategories.map((categoryGroup) => (
                <button
                  ...
                  className={`relative px-6 md:px-8  py-3 rounded-full text-xs md:text-base font-semibold transition-colors duration-300 z-10 ${activeTab === categoryGroup.categoryName ? "text-white" : "text-gray-400 hover:text-white"
                    }`}
                >
