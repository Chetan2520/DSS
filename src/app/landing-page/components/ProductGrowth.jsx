...
export default function ProductGrowth() {
  return (
    <section id="product-growth" className="w-full flex flex-col lg:flex-row overflow-hidden border-t border-[#DDDCCF]">
      ...
      <div className="lg:w-[40%] bg-[#5B8266] text-white py-20 px-8 lg:py-12 md:py-20 lg:px-16 flex flex-col justify-center relative">
        ...
        >
          ...
          <button className="bg-[#F8F5EA] text-[#5B8266] rounded-full px-8 py-4 font-semibold text-sm uppercase tracking-wider hover:bg-white transition-colors flex items-center gap-3 group w-fit">
            Explore Journey
        ...
        <div className="pt-20 px-8 lg:pt-24 lg:px-16 w-full">
          ...
          >
            <div className="text-center md:border-r border-[#DDDCCF]/80 px-4">
              <div className="text-3xl lg:text-3xl text-[#5B8266] font-playfair font-semibold mb-2">01</div>
              <div className="text-xs text-[#5F675F] uppercase tracking-wider font-semibold">Discovery</div>
            </div>
            <div className="text-center md:border-r border-[#DDDCCF]/80 px-4">
              <div className="text-3xl lg:text-3xl text-[#5B8266] font-playfair font-semibold mb-2">02</div>
              <div className="text-xs text-[#5F675F] uppercase tracking-wider font-semibold">Education</div>
            </div>
            <div className="text-center md:border-r border-[#DDDCCF]/80 px-4">
              <div className="text-3xl lg:text-3xl text-[#5B8266] font-playfair font-semibold mb-2">03</div>
              <div className="text-xs text-[#5F675F] uppercase tracking-wider font-semibold">Conversion</div>
            </div>
            <div className="text-center px-4">
              <div className="text-3xl lg:text-3xl text-[#5B8266] font-playfair font-semibold mb-2">04</div>
