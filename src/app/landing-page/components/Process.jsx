...
export default function Process() {
  const steps = [
    { title: "DISCOVER", desc: "Understand your product and goals." },
    { title: "AUDIT", desc: "Analyse your ads and customer journey." },
    { title: "STRATEGIZE", desc: "Build your acquisition strategy." },
    { title: "LAUNCH", desc: "Launch campaigns and creatives." },
    { title: "OPTIMIZE", desc: "Analyse performance and test." },
    { title: "SCALE", desc: "Scale channels with sustainable growth." },
  ];

  return (
    <section id="our-process" className="py-12 md:py-20 bg-[#F8F5EA] text-[#18221B] overflow-hidden border-t border-[#DDDCCF]">
      <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 xl:px-20">
        ...
        <div className="max-w-3xl mx-auto text-center mb-24">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="font-playfair text-4xl sm:text-4xl md:text-5xl lg:text-5xl font-semibold leading-[1.1] text-[#18221B] mb-6"
          >
        ...
        <div className="max-w-6xl mx-auto py-12 md:py-20 w-full relative">
          ...
          <div className="hidden md:flex flex-row items-start justify-between gap-0 relative px-0">
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center px-2">
                    ...
                    <p className="text-xs text-[#5F675F] max-w-[120px] mx-auto">{step.desc}</p>
                  </div>
